package com.example.kmpuniversalapp.infrastructure.network

import com.example.kmpuniversalapp.core.base.AppConfig
...
val networkModule = module {
    single<io.ktor.client.HttpClient> { HttpClient.create() }
}
